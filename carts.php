...
?>
  ...
  <div class="slideshow-container h-100">
    ...
    <div class="mySlides fade">
      ...
      <div class="text"><h1 style="color:#00b300">WOMEN'S SALE IN THREE HOURS</h1></div>
    </div>
    <div class="mySlides fade">
      <div class="numbertext"><h4>4 / 5</h4></div>
      <img src="banner4.jpg" style="width:100%">
      <div class="text"><h1 style="color:#00b300">SHOES PRICES SLASHED BY HALF</h1></div>
    </div>
    <div class="mySlides fade">
      <div class="numbertext"><h4>5 / 5</h4></div>
      <img src="banner5.jpg" style="width:100%">
      <div class="text"><h1 style="color:#00b300">ACCESSORIES AVAILABLE AT LOW COST</h1></div>
    </div>
...
?>
  ...
  <div class="footer">
    <div class="footer_agile_inner_info_w3l">
          ...
          <div class="col-md-5 sign-gd-two"  style="float:right">
            ...
            <div class="w3-address">
              ...
              <div class="w3-address-grid">
                ...
                <div class="w3-address-right">
                  <h6>Email Address</h6>
                  <p>Email :<a href="mailto:example@email.com"> ekaanshsahni@gmail.com</a></p>
                </div>
                  <div class="clearfix"> </div>
              </div>
              <div class="w3-address-grid">
      ...
      <p class="copy-right">&copy 2020 Blue Lagoon Shopping. All rights reserved | Design by EKE SEL</a></p>
    </div>
  </div>
